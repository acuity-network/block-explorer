...
describe('selectors/blocks', () => {
  ...
  describe('getBlockForDisplay', () => {
    ...
    const getSingleBlock = jest.fn(() => blockInState);
    const block = selectors.getBlockForDisplay(10, {}, { getSingleBlock });
